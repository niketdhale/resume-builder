  ...
  <div class="p-5 flex flex-col gap-6">
    ...
    <div>
      ...
      <div class="bg-white border border-gray-100 rounded-xl p-4 shadow-sm flex flex-col gap-4">
        <div>
          <label class="text-xs font-medium text-gray-600 mb-1.5 block">Language</label>
          <select
            :value="activeSettings.language"
            @change="updateSetting('language', $event.target.value)"
            class="w-full text-sm border border-gray-200 rounded-lg px-3 py-2 outline-none focus:border-indigo-400 bg-white"
          >
        ...
        <div>
          <label class="text-xs font-medium text-gray-600 mb-1.5 block">Date Format</label>
    ...
    <!-- Page Format -->
    <div>
      <h3 class="text-xs font-bold uppercase tracking-widest text-gray-400 mb-3">Page Format</h3>
          ...
          >
            <div
              :class="[
                ...
                activePageSize === size.value ? 'border-indigo-400' : 'border-gray-300',
            ...
            <span
              :class="[
                ...
                activePageSize === size.value ? 'text-indigo-600' : 'text-gray-700',
              ]"
            >
              {{ size.label }}
            </span>
            <span class="text-xs text-gray-400">{{ size.dimensions }}</span>
          </button>
        </div>
      </div>
    </div>
