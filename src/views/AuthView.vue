...
async function submit() {
  ...
  const { error: err } = await supabaseAuth.sendMagicLink(email.value.trim(), redirectTo)
        ...
        <div class="flex flex-col gap-4">
          <div class="flex flex-col gap-1.5">
            ...
            <input
              ...
              class="w-full px-3.5 py-2.5 rounded-xl text-sm border outline-none transition"
              :class="[
                isDark
